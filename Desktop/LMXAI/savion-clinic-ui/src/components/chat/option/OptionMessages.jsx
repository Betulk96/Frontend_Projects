...
const OptionMessages = ({ onSelectQuestion }) => {
    ...
    return (
        <div>
            {/* Toggle Button */}
            <button
                className="group fixed right-1 md:right-4 lg:right-8 top-20 sm:top-28 flex items-center justify-center text-color4 dark:text-color11 z-50 bg-white dark:bg-gray-800 p-2 backdrop:blur-sm rounded-full  hover:shadow-color3 transition-all duration-300"
