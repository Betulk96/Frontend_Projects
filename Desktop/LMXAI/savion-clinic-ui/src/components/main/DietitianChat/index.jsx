...
const DietitianChat = () => {
  ...
  return (
    <div className="h-full max-h-[70vh]  p-6 space-y-4 sm:space-y-2 pt-6 bg-white/40 dark:bg-gray-700/30 backdrop-blur-md rounded-2xl shadow-md shadow-color1/30 ">
