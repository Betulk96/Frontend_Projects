export const config = {
  project: {
    name: "Snack Attacks",
    slogan: "Atıştırmalığın Adresi: Snack Attacks!",
    description:
      "Snack Attacks, lezzetli atıştırmalıkları en hızlı ve pratik şekilde kullanıcılarına sunan bir yemek sipariş platformudur. Kullanıcı dostu arayüzü ve geniş ürün yelpazesiyle, her damak zevkine uygun atıştırmalıkları kolayca sipariş edebilmenizi sağlar. İster evde ister işte olun, canınız atıştırmak istediğinde Snack Attacks her an yanınızda!",
    version: "1.0.0",
  },
  contact: {
